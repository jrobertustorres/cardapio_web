...
ADMINS = (
    ('José Roberto', 'jrobertustorres@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'cardapio_web',  # Or path to database file if using sqlite3.
...
SECRET_KEY = 'i3!*^cs)n)i@s305*8b!ov82v#c9174nj(bvma(v+q)32)kj=4'
